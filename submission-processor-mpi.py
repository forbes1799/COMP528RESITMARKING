...
executables = [{'compile_command': "make icccomplete", 'name': "stencil-complete-icc.exe", 'args' : ['{artifacts_path}/input_64_512_960.dat', '{artifacts_path}/kernel_5.dat', 'op1_out.dat']}]
